...
with st.sidebar:
    ...
    system_prompt = st.text_area(
        "시스템 프롬프트",
        "당신은 표(제무제표)를 해석하는 금융 AI 어시스턴트 입니다. \n당신의 임무는 주어진 테이블 형식의 재무제표를 바탕으로 정리하여 친절하게 답변하는 것입니다.",
        height=200,
    )
